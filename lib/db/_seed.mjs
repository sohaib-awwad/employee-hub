...
const employees = [
  ["Lina Hassan", "admin@example.com", "People Ops", "HR Manager",
   "2022-01-10", "female", "LH", "+962790000001", null, "admin", ADMIN_HASH],
  ["Sohaib Awwad", "employee@example.com", "Engineering", "Software Engineer",
   "2024-03-01", "male", "SA", "+962790000000", "Lina Hassan", "employee", EMPLOYEE_HASH],
];
...
const announcements = [
  ...
  ["Team Building Retreat", "Annual team building retreat at the lake resort — sign up by July 10th.", "Company News", "medium", "event", "2026-07-15"],
  ["Tech Talk: AI in HR", "Lunch & learn session on AI tooling in HR workflows, Thursday 1pm.", "Learning", "low", "event", "2026-06-20"],
